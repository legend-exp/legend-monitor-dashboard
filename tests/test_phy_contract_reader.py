...
def test_no_lmon_import(tmp_path):
    script = (
        ...
        "from legenddashboard.spms import sipm_monitoring  # noqa: F401\n"
        "from legenddashboard.muon import muon_monitoring  # noqa: F401\n"
        "from legenddashboard import notes  # noqa: F401\n"
